...
describe Brazilian do
  describe 'scopes' do
    describe '.reverse' do
      let!(:first) { create(:brazilian) }
      let!(:last)  { create(:brazilian) }
  ...
  describe '#first_name' do
    let(:brazilian) { create(:brazilian) }
